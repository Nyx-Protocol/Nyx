...
impl PcrDetector {
    ...
    pub async fn record_event(&self, event: PcrEvent) {
        ...
        if total_pcr > 0 {
            ...
            metrics.avg_pcr_duration =
                Duration::from_millis((total_duration / total_pcr as u128) as u64);
        }
